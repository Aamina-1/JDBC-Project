...
package com.student.com.student.projectSample;
...
public class JdbcConnectionForStudent {
	...
	public static void main(String[] args) throws SQLException, NullPointerException, Exception {
		...
		connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/learners", "root", "Aamina@123");
		...
		case 1:
			...
			int noOfstudentTobeInserted = obj.nextInt();
